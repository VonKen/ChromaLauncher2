...
public class ExtraConstants {
    ...
    public static final String MICROSOFT_LOGIN_TODO = "ms_login_done";
    ...
    /* ExtraCore constant: Target game directory for per-instance mod installation */
    public static final String INSTANCE_MODS_DIR = "instance_mods_dir";
}
