...
public class LauncherPreferences {
    ...
    public static String PREF_ALSOFT_DRIVER = "";
    ...
    public static boolean PREF_THERMAL_WARNINGS = true;
    ...
    public static void loadPreferences(Context ctx) {
        ...
        PREF_ALSOFT_DRIVER = DEFAULT_PREF.getString("alsoftDriver", "");
        ...
        PREF_THERMAL_WARNINGS = DEFAULT_PREF.getBoolean("thermalWarnings", true);
