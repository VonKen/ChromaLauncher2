...
/**
 * Discovers native library plugins installed as separate apps. A plugin declares
 * FCLNativePlugin=true and environment="K=V ..." meta-data; the env vars are merged
 * into the launched JVM's environment and its nativeLibraryDir is added to the
 * library path. Ported from Fold Craft Launcher
 * (com.tungsten.fclauncher.plugins.NativeLibPlugin).
 */
object NativeLibPlugin {
    ...
    /** All enabled native lib plugins' JVM environment variables. */
