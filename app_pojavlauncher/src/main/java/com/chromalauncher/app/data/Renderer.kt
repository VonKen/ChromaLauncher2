package com.chromalauncher.app.data

/**
 * A renderer that can be used to launch Minecraft. Ported from Fold Craft Launcher
 * (com.mio.data.Renderer). Built-in renderers have an empty [path] and are shipped
 * with the launcher; plugin renderers are provided by installed apps that declare
 * fclPlugin metadata and point to their own nativeLibraryDir.
 */
data class Renderer(
    val name: String,
    val des: String,
